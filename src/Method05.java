...
//      메소드 호출하기
//      1. 메서드 호출하기 : 동일한 클래스의 멤버끼리 호출하는 것
...
//      생성자 : 지정한 클래스를 기반으로 객체를 생성
        avante = new Car2(); //Car2클래스 객체가 생성되고 Car2 클래스 타입의 변수 avante에 대입되어 사용 준비가 완료 됨
...
//      Car2 클래스 타입의 객체를 생성
        ...
        Car4 genesis = new Car4("제네시스", "세단");
        genesis.info();

        Car4 audi = new Car4("아우디", "세단");
        audi.info();
