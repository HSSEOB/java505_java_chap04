...
//              Calc 클래스의 멤버 메서드인 abs, max, min이 모두 정적 멤버이기 때문에 객체 생성없이 클래스 이름으로 직접 접근이 가능함.
//              정적 멤버는 해당 클래스를 객체화하여 사용 시 객체화 된 모든 객체들과 함께 메모리 공간을 공유 함.
                ...
                System.out.println("객체 c1의 sResult : " + c1.sResult);
                System.out.println("Calc클래스의 sResult : " + Calc.sResult);
